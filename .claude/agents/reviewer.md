...
- Edit: make minor inline corrections (style, comments, small logic fixes)
- Write: update artifact files with review verdicts
- Grep: search for security/smell patterns
